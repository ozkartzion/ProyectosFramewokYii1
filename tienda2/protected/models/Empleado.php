...
class Empleado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_empleado, apellido_empleado, direccion_empleado, telefono_empleado, email_empleado, sexo_empleado, id_cargo', 'required'),
			array('telefono_empleado, id_cargo', 'numerical', 'integerOnly'=>true),
			array('nombre_empleado, apellido_empleado, direccion_empleado, email_empleado, sexo_empleado', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_empleado, nombre_empleado, apellido_empleado, direccion_empleado, telefono_empleado, email_empleado, sexo_empleado, id_cargo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('apellido_empleado',$this->apellido_empleado,true);
