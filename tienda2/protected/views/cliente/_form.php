...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'id_tipocliente',CHtml::listData(TipoCliente::model()->findAll(),'id_tipocliente','nombre_tipocliente'),array('empty'=>'Seleccione Tipo Cliente')); ?>
