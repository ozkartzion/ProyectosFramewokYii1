...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'id_empresa',CHtml::listData(Empresa::model()->findAll(),'id_empresa','nombre_empresa'),array('empty'=>'Seleccione Empresa')); ?>
		<?php echo $form->error($model,'id_empresa'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'id_tipoproducto'); ?>
		<?php echo $form->dropDownList($model,'id_tipoproducto',CHtml::listData(TipoProducto::model()->findAll(),'id_tipoproducto','nombre_tipoproducto'),array('empty'=>'Seleccione Tipo de Producto')); ?>
