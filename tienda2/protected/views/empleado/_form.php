...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'apellido_empleado'); ?>
		<?php echo $form->textField($model,'apellido_empleado',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'apellido_empleado'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'id_cargo',CHtml::listData(Cargo::model()->findAll(),'id_cargo','nombre_cargo'),array('empty'=>'Seleccione Cargo')); ?>
